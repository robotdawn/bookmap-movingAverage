...
public class MovingAverage implements CustomModule, BarDataListener {
    Indicator indicator;
    ...
    public void initialize(String s, InstrumentInfo instrumentInfo, Api api, InitialState initialState) {
        indicator = api.registerIndicator("moving average", Layer1ApiUserMessageModifyIndicator.GraphType.PRIMARY);
