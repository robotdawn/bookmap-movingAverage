...
@Layer1StrategyName("Moving Average Backfilled")
@Layer1ApiVersion(Layer1ApiVersionValue.VERSION2)

public class MovingAverageBackfilled implements CustomModule, BarDataListener, BackfilledDataListener {
    Indicator indicator;
    ...
    public void initialize(String s, InstrumentInfo instrumentInfo, Api api, InitialState initialState) {
        indicator = api.registerIndicator("mov avg backfilled", Layer1ApiUserMessageModifyIndicator.GraphType.PRIMARY);
